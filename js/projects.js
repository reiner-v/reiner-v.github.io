...
const projects = {
    "project-5": {
        ...
        description: "Self-designed and Developed. A high-impact personal portfolio that merges bold, graphic-led aesthetics with modern front-end development. This project showcases my ability to translate complex graphic identities into a responsive, accessible web experience using HTML, CSS, and JavaScript—bringing a unique visual identity with clean, functional code.",
